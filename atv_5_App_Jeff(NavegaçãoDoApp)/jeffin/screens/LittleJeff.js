...
<Image  style={styles.imagemJeff} source={require('../assets/academia.png')}/> 
<Text style={{fontSize:18}}>Você quer ir para a aula do jeff musculinho?</Text>

<View style={styles.card}>
<TouchableOpacity style={styles.button} onPress ={() => navigation.navigate('Musculinho')}>
